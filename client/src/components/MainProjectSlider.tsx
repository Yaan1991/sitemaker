    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-between p-4 sm:p-6 md:p-8 lg:p-12 max-w-2xl">
        ...
        <div className="flex items-center gap-2 sm:gap-3 md:gap-4 mb-3 sm:mb-4 md:mb-6">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-cinzel font-bold text-white">{category.title}</h3>
        </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-baseline gap-2 sm:gap-3 md:gap-4">
                <h4 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-cinzel font-bold text-white leading-tight">
