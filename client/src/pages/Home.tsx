        ...
        <section className="py-20 px-6">
          <div className="container mx-auto max-w-4xl">
            ...
            >
              ...
              <p className="text-xl text-gray-300 leading-relaxed mb-8">Я соединяю музыку, звук и технологии, чтобы создавать проекты, которые работают безупречно — от идеи до последнего собранного проекта.</p>
