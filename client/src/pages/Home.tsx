    ...
    projects: [
      {
        ...
        title: "Идиот",
        year: "2024",
        description: "Радикально переосмысленная постановка по Достоевскому. Действие перенесено в Саратов 1999 года, объединяет живое театральное действие с киносъёмкой.",
      ...
      },
      {
        ...
        year: "2024",
        description: "Моноспектакль о поэте с трёхуровневой звуковой концепцией, переходящей между различными зонами для создания кинематографичной атмосферы.",
      ...
      },
      {
        ...
        year: "2025",
        description: "Звуковой комикс с 12 полноценными композициями разных жанров, отражающий комиксную эстетику проекта.",
