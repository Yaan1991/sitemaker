        ...
        <section className="py-32 px-6 relative">
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            >
              ...
              <p className="text-lg text-gray-400 leading-relaxed mb-8">Работаю в широком спектре жанров. Помимо театральных и кинопроектов, создаю джинглы и саунд-дизайн для брендов, разрабатываю аудиопрограммы и автоматизацию для проектов, совмещая творчество и технологии. Активно использую нейросети и ИИ-инструменты для генерации, анализа и обработки звука, расширяя границы традиционного саунд-дизайна.</p>
